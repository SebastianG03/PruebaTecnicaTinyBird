...
def valid_events(raw_test_events):
    ...
    events = validator.total_events(raw_test_events, MetricsEntry(country="", from_date="", to_date=""))
    return events
...
def test_group_by_event_type(valid_events, metrics_manager):
    ...
    assert "product_view" in grouped or "add_to_cart" in grouped or "purchase" in grouped
...
def test_revenue_calculation(valid_events, metrics_manager):
    ...
    expected_revenue = sum(
        float(e.price) for e in valid_events 
...
def test_unique_users_count(valid_events, metrics_manager):
    ...
    unique_users_from_events = len({
        e.user_id for e in valid_events if e.user_id
    })
...
def generate_test_events():
    ...
    return [
        Events.model_validate({
            ...
            "product_id": "p_10", "timestamp": "2025-05-03T10:15:00Z", "price": 0, "country": "CR"
        }),
        Events.model_validate({
            "event_id": "evt_002", "user_id": "u_123", "event_type": "product_view",
            "product_id": "p_10", "timestamp": "2025-05-03T10:16:00Z", "price": 0, "country": "CR"
        }),
        Events.model_validate({
            "event_id": "evt_003", "user_id": "u_456", "event_type": "purchase",
            "product_id": "p_10", "timestamp": "2025-05-03T10:20:00Z", "price": 99.99, "country": "CR"
        }),
        Events.model_validate({
            "event_id": "evt_004", "user_id": "u_789", "event_type": "purchase",
            "product_id": "p_25", "timestamp": "2025-05-04T10:00:00Z", "price": 149.50, "country": "EC"
        }),
    ]
